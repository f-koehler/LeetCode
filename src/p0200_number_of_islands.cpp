...
namespace P0200 {
    class Solution {
      public:
        int numIslandsBFS(std::vector<std::vector<char>> &grid) {
            ...
            const auto visit_island_bfs =
                [&grid, &num_rows, &num_cols](int start_row, int start_col) {
                    std::stack<std::pair<int, int>> to_visit{
                        {{start_row, start_col}}};
                    grid[start_row][start_col] = '2';
                    while (!to_visit.empty()) {
                        const auto [row, col] = to_visit.top();
                        to_visit.pop();
    ...
    TEST_CASE("0200 - Number of Islands",
              "[Array][Depth-First Search][Breadth-First Search][Union "
              "Find][Matrix]") {
        ...
        SECTION("BFS") {
            SECTION("Example 1") {
                ...
                REQUIRE(s.numIslandsBFS(grid) == 1);
            }
            ...
            SECTION("Example 2") {
                ...
                std::vector<std::vector<char>> grid = {
                    ...
                    {'0', '0', '1', '0', '0'},
                    {'0', '0', '0', '1', '1'}};
                REQUIRE(s.numIslandsBFS(grid) == 3);
            }
        }
        SECTION("DFS") {
            SECTION("Example 1") {
