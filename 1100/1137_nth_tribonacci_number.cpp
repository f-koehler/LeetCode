    ...
    class Solution {
      ...
      public:
        int tribonacci(int n) {
            ...
            // The problem statement guarantees us, that the solution fits into
            // the given integer type. I would have preferred it to be at least
        ...
        int tribonacciNoCache(int n) {
            std::array<uint64_t, 3> buffer{
                0, 1, 1}; // ring buffer-like array containg
